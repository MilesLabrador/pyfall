locations = {
	...
	"Beach" : ['Beach waitress','Kite Surfer','Lifeguard','Theif','Beach Goer','Beach Photographer','Ice Cream Truck Driver'],
	"Broadway Theater" : ['Coat Check Lady','Prompter','Cashier','Vistor','Director','Actor','Crewman'],
	...
	"Movie Studio" : ['Stuntman','Sound Engineer','Cameraman','Director','Costume Artist'],
	...
	"Pirate Ship" : ['Cook','Sailor','Worker without pay','Cannoneer','Bound Prisioner','Cabin Boy','Brave Captain'],
